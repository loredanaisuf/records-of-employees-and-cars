...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(authenticatedUser != null){
            ...
            serviceAutentificare.addUser(new TabelAutentificare(UUID.randomUUID().toString(), selector, validator, authenticatedUser.getId().toString()));
            ...
            if(authenticatedAdmin != null){
                ...
                String selector = UUID.randomUUID().toString();
                String validator = UUID.randomUUID().toString();
                serviceAutentificare.addAdmin(new TabelAutentificare(UUID.randomUUID().toString(), selector, validator, authenticatedAdmin.getFirma()));
