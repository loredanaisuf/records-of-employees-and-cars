...
<div class="container"  style="background-color: #f2f2f2;">
    <div class="row" style="align-items: center; margin-top: 10px;">
        ...
        <div class="col-sm-12" style="background-color: #660020;" >
            <h4 style="text-align: center;margin: 15px; color:white">~Adaugare informatii~</h4>
        </div>
            ...
            <div style="align-items: center; background-color: #f2f2f2;">
                <form method="post">
                    <div class="form-group" style="margin-bottom: 10px">
                        <label for="data" style="margin-top: 30px; font-weight: bold">Data</label>
                        <input type="date" id="data" name="data" required>
                    </div>

                    <div class="form-group" style="margin-bottom: 10px">
                        <label for="nr_km" style="margin-top: 30px; font-weight: bold">Numarul de km</label>
                        <input type="text" placeholder="Introdu nr de km" id="nr_km" name="numar_km" required>
                    </div>

                    <div class="form-group" style="margin-bottom: 10px">
                        <label for="cant" style="margin-top: 30px;font-weight: bold">Litri de motorina</label>
